...
export const ChatHeader = forwardRef(function ChatHeader({ onClose }, ref) {
      ...
      <p className="text-sm text-center">
        ...
        >
          <span className="inline-flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-blueGray" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16.72 11.06a6.5 6.5 0 10-2.28 2.28l2.54.73a1 1 0 001.26-1.26l-.73-2.54z" /></svg>
